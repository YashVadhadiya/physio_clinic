...
export function VisitPage() {
  ...
  useEffect(() => {
    loadVisits();
  }, [page, filterDate, filterWorker, filterType]);
    ...
    <div className="page-container">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">View all patient visits</p>
        </div>
        <button className="btn btn-secondary btn-sm" onClick={loadVisits}>
      ...
      <div className="filters-bar">
        <div className="form-group" style={{ marginBottom: 0 }}>
          <input type="date" className="form-input" value={filterDate} onChange={e => { setFilterDate(e.target.value); setPage(1); }} />
        </div>
        <div className="form-group" style={{ marginBottom: 0 }}>
          <select className="form-select" value={filterWorker} onChange={e => { setFilterWorker(e.target.value); setPage(1); }}>
